  ...
  var send = react_1.useCallback(function (event, data, resource) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [2 /*return*/, fetch.apply(void 0, getParams(resource || resourceRef.current, event, data))];
      });
    });
  }, []);
  var sendAbortable = react_1.useCallback(function (event, data, resource) {
    if (data === void 0) {
      data = {};
    }
    return abortableFetch.apply(void 0, getParams(resource || resourceRef.current, event, data));
  }, []);
