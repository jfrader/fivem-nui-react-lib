...
var NuiProvider = function (_a) {
  ...
  var eventListener = function (event) {
    ...
    if (app && method) {
      window.dispatchEvent(
        new MessageEvent((0, eventNameFactory_1.eventNameFactory)(app, method), {
          data: data,
        }),
      );
    }
  ...
  var send = (0, react_1.useCallback)(function (event, data, res) {
    if (data === void 0) {
      data = {};
    }
  ...
  return (0, jsx_runtime_1.jsx)(NuiContext_1.NuiContext.Provider, {
    value: {
      send: send,
